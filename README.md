...
In a huge repository it's really useful to have the following shell alias: `alias vzv="fzf | xargs -r vim"`. Using it you can always start from a root of a huge repo and avoid cd-ing into directories and hintting <TAB> a lot.
